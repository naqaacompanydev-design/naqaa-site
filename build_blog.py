...
DESC_P1 = ("مدونة مؤسسة نقاء للتنظيف: نصائح وإرشادات التنظيف الاحترافي في الرياض من خبرائنا، "
           "مع خصم 40% لفترة محدودة على جميع الخدمات. اتصل 0545833481.")
TITLE_PN = "مدونة مؤسسة نقاء للتنظيف | صفحة {n} من النصائح"
